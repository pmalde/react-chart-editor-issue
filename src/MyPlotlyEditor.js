...
import EditorControls from 'react-chart-editor';
import PropTypes from 'prop-types';
import {DEFAULT_FONTS} from 'react-chart-editor';

class MyPlotlyEditor extends Component {
  constructor(props) {
    super();
    this.state = {graphDiv: {}};
...
MyPlotlyEditor.defaultProps = {
  hideControls: false,
  showFieldTooltips: false,
  fontOptions: DEFAULT_FONTS,
};

export default MyPlotlyEditor;